...
public class Unit
{
    ...
    */
    ...
    {
        //IF dmg is greater than currentHealth
        {
            //Set currentHelth to 0
        }
        //ELSE
        {
            //Decrement currentHealth by dmg
        }
        //END IF
    }
    ...
    * @pre movecost is greater than currentMoves
    */
    public void decrementMove(int moveCost)
    {
        //Subtract the move cost from the unit's available moves
    }
    ...
    */
    ...
    public String toString()
    {
        ...
        //The string contains the followinf information
        //type
        //current health / max health
        //current moves/ max moves
        //attack value
        //attack range
        //armor value
        return null;
    ...
    */
    public String toStringForFile()
    {
        ...
        //The string's format is type owner current health current moves and
        //can attack. All of these values are comma delimited
        return null;
    }
}
