...
public class TolecoAppTest {
    ...
    @Test
    public void testDefect216()
    {
        TolecoApp app = new TolecoApp();
        System.out.println("In this test, click once on a map, then press cancel" +
                ", it should return to the main menu");
        JOptionPane.showMessageDialog(app, "In this test, click on a map once," +
                " then press cancel, it should return to the main menu");
        ActionEvent event = new ActionEvent(app, 1, "newgame");
