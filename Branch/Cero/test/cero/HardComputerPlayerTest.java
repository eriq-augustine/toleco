...
public class HardComputerPlayerTest {
    ...
    public HardComputerPlayerTest() {
    }

    private FakeController control;
    private HardComputerPlayer player;
    ...
    public void testDoTurn() {
        ...
        System.out.println("Testing doTurn() in HardComputerPlayer: ");
        //Make a hand
    ...
    public void testDoTurnDraw() {
        System.out.println("Testing doTurn() in HardComputerPlayer with " +
                "drawing:\n(Also tests findCard())");
        hand.add(Card.valueOf("B8"));
