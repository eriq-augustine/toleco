...
public class MapView extends JPanel
{
    ...
    */
     ...
     * @param numRows the number of rows that the map will represent
     * @param numCols the number of columns that the map will represent
     * 
     * display
     */
    public MapView(HashMap<String, BufferedImage> images, int numRows, int numCols)
    {
        ...
        String[] emptyCols = new String[numCols];
