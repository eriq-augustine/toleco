...
public class SwingGameView extends Observable implements I_GameView
{
    ...
    */
    ...
    /**
     * The width of a single cell in the map.
     */
    private static final int kCellWidth = 41;
    ...
    /**
     * The height of a single cell in the map.
     */
    private static final int kCellHeight = 41;
    ...
    /**
     * The ratio of space used by the status view to that of the buttons.
     */
    private static final double kStatusToButtonRatio = .75;
    ...
    */
    ...
    public SwingGameView(GameBoard board)
    {
        ...
        //Set the width of the map as the number of Cols times the cell width
        mapWidth = board.getNumCols() * kCellWidth;

        //Set the height of the map as the number of Cols times the cell width
        mapHeight = board.getNumRows() * kCellHeight;
        ...
        map = new MapView(images, board.getNumRows(), board.getNumCols());
    ...
    */
    ...
    {
        //Set panel's maximum size to mapWidth x mapHeight.
        panel.setMaximumSize(new java.awt.Dimension(mapWidth + kStatusWidth, mapHeight));
        //Set panel's minimum size to mapWidth x mapHeight.
        panel.setMinimumSize(new java.awt.Dimension(mapWidth + kStatusWidth, mapHeight));
        //Set panel's prefered size to mapWidth x mapHeight.
        panel.setPreferredSize(new java.awt.Dimension(mapWidth + kStatusWidth, mapHeight));
        ...
        //Set innerPanel's maximum size to kStatusWidth x mapHeight.
        innerPanel.setMaximumSize(new java.awt.Dimension(kStatusWidth, mapHeight));
        //Set innerPanel's minimum size to kStatusWidth x mapHeight.
        innerPanel.setMinimumSize(new java.awt.Dimension(kStatusWidth, mapHeight));
        //Set innerPanel's prefered size to kStatusWidth x mapHeight.
        innerPanel.setPreferredSize(new java.awt.Dimension(kStatusWidth, mapHeight));
        ...
        //Set status's maximum size to kStatusWidth x mapHeight * kStatusToButtonRatio.
        status.setMaximumSize(new java.awt.Dimension(kStatusWidth, 
            (int)(mapHeight * kStatusToButtonRatio)));
        //Set status's minimum size to kStatusWidth x mapHeight * kStatusToButtonRatio.
        status.setMinimumSize(new java.awt.Dimension(kStatusWidth, 
            (int)(mapHeight * kStatusToButtonRatio)));
        //Set status's prefered size to kStatusWidth x mapHeight * kStatusToButtonRatio.
        status.setPreferredSize(new java.awt.Dimension(kStatusWidth, 
            (int)(mapHeight * kStatusToButtonRatio)));

        //Set buttons's maximum size to kStatusWidth x
        // mapHeight * (1 - kStatusToButtonRatio).
        buttons.setMaximumSize(new java.awt.Dimension(kStatusWidth, 
            (int)(mapHeight * (1 - kStatusToButtonRatio))));
        //Set buttons's minimum size to kStatusWidth x
        // mapHeight * (1 - kStatusToButtonRatio).
        buttons.setMinimumSize(new java.awt.Dimension(kStatusWidth, 
            (int)(mapHeight * (1 - kStatusToButtonRatio))));
        //Set buttons's prefered size to kStatusWidth x
        // mapHeight * (1 - kStatusToButtonRatio).
        buttons.setPreferredSize(new java.awt.Dimension(kStatusWidth, 
            (int)(mapHeight * (1 - kStatusToButtonRatio))));
    ...
    */
     ...
     * @pre board is not null
     */
    public void drawMap(Player activePlayer)
    {
        ...
        //switch to the currently active player
