...
public class ConsoleGameView extends Observable implements I_GameView
{
    ...
    */
    ...
    public void start(Player activePlayer)
    {
        ...
        //Set the activePlayer to the passed in player.
    ...
    */
    ...
    {
        //Set activePlayer to the passed in Player.
        this.activePlayer = activePlayer;
        ...
        //Print an initial 3 spaces.
        System.out.print("   ");

        //FOR all columns in the map
        for (int col = 0; col < map[0].length; col++)
        {
            //If the col is 10 or greater (1 digit).
            if (col < 10)
            {
                //Print 2 spaces, col, and then 2 more spaces.
                System.out.printf("  %d  ", col);
            }
            //ELSE
            else
            {
                //Print 1 space, col, and then 2 more spaces.
                System.out.printf(" %d  ", col);
            }
            //ENDIF
        }
        ...
        {
            //If the row is 10 or greater (1 digit).
            if (row < 10)
            {
                //Print the row then a space
                System.out.printf("%d ", row);
            }
            //ELSE
            else
            {
                //Print the row with no spaces.
                System.out.printf("%d", row);
            }
            //ENDIF
