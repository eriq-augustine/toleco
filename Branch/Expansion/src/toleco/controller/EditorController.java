...
public class EditorController implements I_Controller
{
    ...
    */
     ...
     */
    private String chosenBackStory;
    ...
    */
    ...
    public EditorController(GameBoard board)
    {
        ...
        //Initialize the backstory.
        chosenBackStory = new String("");
    }
    ...
    */
    ...
    {
        //CALL board.setBackStory with the chosen backStory
        board.setBackStory(chosenBackStory);
        ...
        if(obj instanceof String)
        {
            ...
            switch (action)
            {
                ...
                case kChoosePlayer:
                    ...
                    break;
                //kChooseBackStory: get the backstory
                case kChooseBackStory:
                    //Set chosenBackStory to the rest of the line (trimed).
                    chosenBackStory = actionSc.nextLine().trim();
                    break;
    ...
    */
    public Player loadMap(String fileName) throws java.io.FileNotFoundException
    {
        //CALL board.loadMap with fileName
        return board.loadMap(fileName);
    }
    ...
    {
        //Draw the map with the chosen player.
        view.drawMap(chosenPlayer);
    }
