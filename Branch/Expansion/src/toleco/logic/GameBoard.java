...
public class GameBoard extends Observable
{
    ...
    */
    ...
    public Player loadMap(String fName) throws java.io.FileNotFoundException
    {
        ...
        //Player enum (kPlayer1 or kPlayer2)
        //The number of rows and columns the board has seperated by whitespace.
        ...
        try
        {
            ...
            do
            {
                ...
                if (temp.length() > 0 && temp.charAt(0) != '#')
                {
                    //Create a new scanner from the line.
                    Scanner dimScanner = new Scanner(temp);

                    //Set numRows equals to the next int.
                    numRows = dimScanner.nextInt();

                    //Set numCols equals to the next int.
                    numCols = dimScanner.nextInt();

                    //IF numRows or numCols are out of bounds.
                    if (numRows <= 0 || numCols <= 0)
                    {
                        //Throw an IllegalArgumentExcaption
                        String message = "Dimensions must be greater than zero.";
                        throw new java.lang.IllegalArgumentException(message);
                    }
                    //ENDIF

                    //Initialize map as a 10 x 10 array of Terrain.
                    map = new Terrain[numRows][numCols];
                }
                //WHILE the read line does not begin with a '#'.
            } while (temp.charAt(0) == '#');
            //ENDWHILE
    ...
    */
    public void saveMap(String fName, Player activePlayer)
    {
        ...
        try
        {
            ...
            //Write the number of rows the board has followed by a space.
            out.write(numRows + " ");

            //Write the number of cols the board has followed by a new line.
            out.write(numCols + "\n");
    ...
    */
    ...
    /**
     * Gets the number of rows that the current board has.
     */
    ...
    /**
     * Gets the number of columns that the current board has.
     */
