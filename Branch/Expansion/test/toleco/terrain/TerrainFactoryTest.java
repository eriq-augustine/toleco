...
public class TerrainFactoryTest {
    ...
    public static void setUpClass() throws Exception 
    {
        ...
        TestTerrain3 = new Terrain("TestTerrain3", 1, 2, 3, 4);
        ...
        terrainProps2.setProperty("type",TestTerrain3.getType());
        terrainProps2.setProperty("defMod", TestTerrain3.getDefMod()+"");
        terrainProps2.setProperty("moveCost", TestTerrain3.getMoveCost()+"");
    ...
    public void testBuild() {
        ...
        Terrain expResult = new Terrain("TestTerrain3", 1, 2, 3, 4);

        TerrainFactory factory = new TerrainFactory();
        Terrain result = factory.build("TestTerrain3", 3, 4);
